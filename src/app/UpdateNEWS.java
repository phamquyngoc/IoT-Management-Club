...
public class UpdateNEWS extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       ResultSet rs=st.executeQuery("select *from news where idNews='"+idNews+"'");
       while(rs.next()){
       checkidNews=1;
       ...
       if(checkidNews==0){
       JOptionPane.showMessageDialog(null,"Thong bao khong ton tai!");  
       }
       }
       catch(Exception e){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        int a=JOptionPane.showConfirmDialog(null, "Xoa thong bao?","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
        String idNews=jTextField1.getText();
        try{
        Connection con=ConnectionProvider.getCon();
        Statement st=con.createStatement();
        st.executeUpdate("delete from news where idNews='"+idNews+"'");
